      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p>
              Advanced 3D digital dental technology for painless Guided & Immediate 
              Dental Implants. Rated 5.0 stars by 132+ happy patients.
            </p>
            <div className="footer-social">
              <a href="https://facebook.com/vijayadental" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://instagram.com/vijayadental" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <div className="footer-column">
            ...
            <div className="footer-contact">
              <div className="footer-contact-item">
                ...
                <span>Opp. Veeramma Cheruvu Park, Gandhinagar, Bhimavaram, AP 534201</span>
              </div>
              <div className="footer-contact-item">
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; {currentYear} Vijaya Multispeciality Dental Clinic. All rights reserved.
          </p>
